...
namespace Persistence.Migrations
{
    ...
    [Migration("20240824124009_TaskAssignPackageWise")]
    partial class TaskAssignPackageWise
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Parlour.PrPackageService", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("PackageServiceId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Entities.Parlour.PrServiceSpMap", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("ServiceBillDetailId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ServiceBillDetailId");

                    b.HasIndex("ServiceId");

                    b.HasIndex("UpdatedById");

                    b.ToTable("PrServiceSpMaps");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Parlour.PrPackageService", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Parlour.PrServiceInfo", "PackageService")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.Parlour.PrServiceSpMap", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Parlour.PrServicesBillDetail", "ServiceBillDetail")
                        .WithMany()
                        .HasForeignKey("ServiceBillDetailId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("ServiceBillDetail");
